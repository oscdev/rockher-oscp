...
public class All_Product_Fixed_I {
	...
	public void f() throws InterruptedException, IOException {
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\I_All_Customer\\Product_Fixed\\screenshots" + System.currentTimeMillis() + ".png"));
	    System.out.println("the Screenshot of cart page is taken");
		   ...
		   if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
			 ...
			 //Add quantity - 10
			    ...
			    // Copy file at destination
			    FileHandler.copy(source2, new File("D:\\\\All Selenium Webdriver Screenshots\\\\CPW Dev Testing\\\\I_All_Customer\\\\Product_Fixed\\\\screenshots"+System.currentTimeMillis()+".png"));
			    ...
			    Thread.sleep(2000);
		              ...
		              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
		              {
		      		    ...
		      		    // Copy file at destination
		      		    FileHandler.copy(source3, new File("D:\\\\All Selenium Webdriver Screenshots\\\\CPW Dev Testing\\\\I_All_Customer\\\\Product_Fixed\\\\Screenshots"+System.currentTimeMillis()+".png"));
		      		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
		      		    Thread.sleep(2000);
		    ...
		    // Copy file at destination
		    FileHandler.copy(source4, new File("D:\\\\All Selenium Webdriver Screenshots\\\\CPW Dev Testing\\\\I_All_Customer\\\\Product_Fixed\\\\Screenshots"+System.currentTimeMillis()+".png"));
