...
public class All_Variant_Percent_I 
{
	@Test
	public void f() throws Exception 
	{
		...
		String ExpectedSubTotal="Rs. 424.65";
		Thread.sleep(2000);
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 685.40";
			Thread.sleep(2000);
		    ...
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 1311.20";
	      			Thread.sleep(2000);
		...
		String ExpectedTotal3="₹1,311.20";
	    Thread.sleep(2000);
		...
		String ExpectedTotal5="₹1,429.21";
	    Thread.sleep(2000);
	    ...
	    if(ActualTotal5.equalsIgnoreCase(ExpectedTotal5)) 
		      { 
	    	      ...
	    	      driver.get("https://cpw-app-v4.myshopify.com/cart");
		      }
	    Thread.sleep(5000);
