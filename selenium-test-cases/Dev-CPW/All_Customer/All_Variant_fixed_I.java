...
public class All_Variant_fixed_I 
{
	...
	public void f() throws Exception 
	{
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\I_All_Customer\\Variant-fixed\\Screenshots"+System.currentTimeMillis()+".png"));
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 160.00";
			Thread.sleep(2000);
		    ...
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 300.00";
	      			Thread.sleep(2000);
		...
		System.out.println("Actual subtotal price is: " +ActualTotal3);
		Thread.sleep(2000);
		
		String ExpectedTotal3="₹327.00";
	    Thread.sleep(2000);
