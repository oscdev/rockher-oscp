...
public class CTag_Product_Percent_III_C2 
{
	@Test
	public void f() throws Exception 
	{
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Product-Percent\\Screenshots"+System.currentTimeMillis()+".png"));
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Product-Percent\\Screenshots"+System.currentTimeMillis()+".png"));
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 722.50";
			Thread.sleep(2000);
		    ...
		    // Copy file at destination
		    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Product-Percent\\Screenshots"+System.currentTimeMillis()+".png"));
		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 1360.00";
	      			Thread.sleep(2000);
	      		    ...
	      		    // Copy file at destination
	      		    FileHandler.copy(source3, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Product-Percent\\Screenshots"+System.currentTimeMillis()+".png"));
	      		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
	      		    Thread.sleep(5000);
		...
		String Expected_Total_3="₹1,360.00";
	    Thread.sleep(2000);
		...
		String Expected_Total3="₹1,482.40";
	    Thread.sleep(2000);
