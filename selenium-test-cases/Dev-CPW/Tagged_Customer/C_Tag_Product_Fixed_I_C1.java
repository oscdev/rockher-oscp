...
public class C_Tag_Product_Fixed_I_C1 
{
	...
	public void f() throws InterruptedException, IOException {
		...
		String ExpectedSubTotal="Rs. 500.00";
		Thread.sleep(2000);
		...
		if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
			...
			Thread.sleep(5000);
			String ExpectedSubTotal1="Rs. 900.00";
			Thread.sleep(2000);
		    ...
		    // Copy file at destination
		    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Product-Fixed\\Screenshots" 
		                                                   + System.currentTimeMillis() + ".png"));
		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
		    Thread.sleep(2000);
  		...
  		// Comparing prices on cart page
  					...
  					String ExpectedSubTotal2="Rs. 1600.00";
  					Thread.sleep(2000);
  					// Screenshot of cart page //
  				    // Convert web driver object to TakeScreenshot
  				    ...
  				    // Copy file at destination
  				    FileHandler.copy(source3, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Product-Fixed\\Screenshots" 
  				                                                   + System.currentTimeMillis() + ".png"));
  				    System.out.println("The Screenshot of Shopping-Cart Page is taken");
  				    Thread.sleep(2000);
		...
		Thread.sleep(5000);
		String ExpectedTotal2="₹1,744.00";
	    Thread.sleep(3000);
	  
	    if(ActualTotal2.equalsIgnoreCase(ExpectedTotal2)) 
	      { 
