...
public class cTag_VarAndProduct_Percent_C1 
{
	@Test
	public void f() throws Exception 
	{
		...
		driver.findElement(By.id("Search-In-Modal")).sendKeys("Classic Varsity Top");
		driver.findElement(By.xpath("//button[@class='search__button field__button']")).click();
		
		// Go to product page
		driver.findElement(By.id("CardLink--8614861308188")).click();
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Variant_Vs_Product\\Screenshots"+System.currentTimeMillis()+".png"));
		...
		Thread.sleep(2000);	
		String ExpectedSubTotal="Rs. 114.00";
		Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Variant_Vs_Product\\Screenshots"+System.currentTimeMillis()+".png"));
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 220.80";
			Thread.sleep(2000);  
			// Screenshot of cart page //
		    // Convert web driver object to TakeScreenshot
		    ...
		    // Copy file at destination
		    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Variant_Vs_Product\\Screenshots"+System.currentTimeMillis()+".png"));
		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 270.00";
	      			Thread.sleep(2000);
	      		    ...
	      		    // Copy file at destination
	      		    FileHandler.copy(source3, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Variant_Vs_Product\\Screenshots"+System.currentTimeMillis()+".png"));
	      		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
	      		    Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source4, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\III_Tagged_Customer\\Variant_Vs_Product\\Screenshots"+System.currentTimeMillis()+".png"));
