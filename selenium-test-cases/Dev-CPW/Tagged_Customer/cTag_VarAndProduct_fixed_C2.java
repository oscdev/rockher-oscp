...
public class cTag_VarAndProduct_fixed_C2 
{
	@Test
	public void f() throws Exception 
	{
		...
		// Go to product page
		driver.findElement(By.id("CardLink--8614863372572")).click();
		...
		String ExpectedSubTotal="Rs. 300.00";
		Thread.sleep(2000);
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 500.00";
			Thread.sleep(2000);
		    ...
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 600.00";
	      			Thread.sleep(2000);
