...
public class CTag_Variant_fixed_II_C2
{
	@Test
	public void f() throws Exception 
	{
		...
		String ExpectedSubTotal="Rs. 260.00";
		Thread.sleep(2000);
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 600.00";
			Thread.sleep(2000);
		...
		String ExpectedTotal3="₹1,100.00";
	    Thread.sleep(2000);
		...
		String ExpectedTotal5="₹1,199.00";
	    Thread.sleep(2000);
