...
public class CTag_Variant_Percent_I_C2
{
	@Test
	public void f() throws Exception 
	{
		...
		String ExpectedSubTotal="Rs. 402.30";
		Thread.sleep(2000);
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 633.25";
			Thread.sleep(2000);
		    ...
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 1192.00";
	      			Thread.sleep(2000);
		...
		String ExpectedTotal3="₹1,192.00";
	    Thread.sleep(2000);
		...
		String ExpectedTotal5="₹1,299.28";
	    Thread.sleep(2000);
