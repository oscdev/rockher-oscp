...
public class LoggedIn_Product_Fixed_I_C1 
{
	...
	public void f() throws InterruptedException, IOException {
	  ...
	  //click on add to cart button
		...
		String ExpectedSubTotal="Rs. 525.00";
		Thread.sleep(2000);
		...
		if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
			...
			String ExpectedSubTotal1="Rs. 950.00";
			Thread.sleep(2000);
		    ...
		    // Copy file at destination
		    FileHandler.copy(source2, new File("D:\\\\All Selenium Webdriver Screenshots\\\\II_LoggedIn_Customer\\\\Product_Fixed\\Screenshots"+System.currentTimeMillis()+".png"));
		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 1700.00";
	      			Thread.sleep(2000);
	      		    ...
	      		    // Copy file at destination
	      		    FileHandler.copy(source3, new File("D:\\\\All Selenium Webdriver Screenshots\\\\II_LoggedIn_Customer\\\\Product_Fixed\\Screenshots"+System.currentTimeMillis()+".png"));
	      		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
	      		    Thread.sleep(5000);
		...
		String Expected_Total_3="₹1700.00";
	    Thread.sleep(2000);
		...
		String Expected_Total3="₹1,853.00";
	    Thread.sleep(2000);
