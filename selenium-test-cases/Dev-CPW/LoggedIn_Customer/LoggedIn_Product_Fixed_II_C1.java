...
public class LoggedIn_Product_Fixed_II_C1 
{
	...
	public void f() throws InterruptedException, IOException {
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Fixed\\Screenshots" 
		...
		String ExpectedSubTotal="Rs. 380.00";
		Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Fixed\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
		...
		if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
			...
			String ExpectedSubTotal1="Rs. 850.00";
			Thread.sleep(2000);
		    ...
		    // Copy file at destination
		    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Fixed\\Screenshots" 
		                                                   + System.currentTimeMillis() + ".png"));
		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
		    Thread.sleep(2000);
  		...
  		// Comparing prices on cart page
  					WebElement subtotal2 = driver.findElement(By.xpath("//p[@class='totals__total-value']"));
  					String ActualsubTotal2 = subtotal2.getText();
  				    System.out.println("Actual subtotal price is: " +ActualsubTotal2);
  					Thread.sleep(2000);
  					
  					String ExpectedSubTotal2="Rs. 1500.00";
  					Thread.sleep(2000);
  				    ...
  				    // Copy file at destination
  				    FileHandler.copy(source3, new File("D:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Fixed\\Screenshots" 
  				                                                   + System.currentTimeMillis() + ".png"));
  				    System.out.println("The Screenshot of Shopping-Cart Page is taken");
  				    Thread.sleep(2000);
		...
		Thread.sleep(2000);
		String ExpectedTotal1="₹1,500.00";
	    Thread.sleep(2000);
		...
		Thread.sleep(2000);
		String ExpectedTotal3="₹1,635.00";
	    Thread.sleep(2000);
		...
		// Screenshot of checkout page 
			    ...
			    // Copy file at destination
			    FileHandler.copy(source4, new File("D:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Fixed\\Screenshots"+System.currentTimeMillis()+".png"));
