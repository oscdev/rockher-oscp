...
public class LoggedIn_Variant_fixed_I_C1 
{
	@Test
	public void f() throws Exception 
	{
		...
		String ExpectedSubTotal="Rs. 64.00";
		Thread.sleep(2000);
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 135.00";
			Thread.sleep(2000);
		    ...
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 220.00";
	      			Thread.sleep(2000);
