...
public class LoggedIn_Variant_Percent_II 
{
	@Test
	public void f() throws Exception 
	{
		...
		// "Product Name - Zulu" [1.Red (Offer applied)]
		...
		// Go to product page
		driver.findElement(By.id("CardLink--8811908006172")).click();
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\II_LoggedIn_Customer\\Variant-Percent\\Screenshots"+System.currentTimeMillis()+".png"));
		...
		String ExpectedSubTotal="Rs. 1017.45";
		Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\II_LoggedIn_Customer\\Variant-Percent\\Screenshots"+System.currentTimeMillis()+".png"));
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 1596.00";
			Thread.sleep(2000);
		    ...
		    // Copy file at destination
		    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\II_LoggedIn_Customer\\Variant-Percent\\Screenshots"+System.currentTimeMillis()+".png"));
		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 2992.50";
	      			Thread.sleep(2000);
	      		    ...
	      		    // Copy file at destination
	      		    FileHandler.copy(source3, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\II_LoggedIn_Customer\\Variant-Percent\\Screenshots"+System.currentTimeMillis()+".png"));
	      		    System.out.println("The Screenshot of Shopping-Cart Page is taken");
	      		    Thread.sleep(2000);
		...
		String ExpectedTotal1="₹2,992.50";
	    Thread.sleep(2000);
		...
		System.out.println("Actual Estimated taxes total price on Checkout is: " +ActualTotal2);
		Thread.sleep(2000);
		
		String ExpectedTotal2="₹269.33";
	    Thread.sleep(2000);
		...
		String ExpectedTotal3="₹3,261.83";
	    Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source4, new File("D:\\All Selenium Webdriver Screenshots\\CPW Dev Testing\\II_LoggedIn_Customer\\Variant-Percent\\Screenshots"+System.currentTimeMillis()+".png"));
