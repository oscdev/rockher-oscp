...
public class LoggedIn_Product_Percent_I_C1 
{
	...
	public void f() throws InterruptedException, IOException {
		...
		// Go to product page
			    ...
			    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Percent\\Screenshots" 
				...
				String ExpectedSubTotal="Rs. 151.68";
				Thread.sleep(2000);
			    ...
			    // Copy file at destination
			    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Percent\\Screenshots" 
			                                                   + System.currentTimeMillis() + ".png"));
				...
				if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
					...
					String ExpectedSubTotal1="Rs. 371.30";
					Thread.sleep(2000);
				    ...
				    // Copy file at destination
				    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Percent\\Screenshots" 
				                                                  + System.currentTimeMillis() + ".png"));
				    System.out.println("The Screenshot of Shopping-Cart Page is taken");
				    Thread.sleep(2000);
		  		...
		  		// Comparing prices on cart page
		  					...
		  					String ExpectedSubTotal2="Rs. 726.80";
		  					Thread.sleep(2000);
		  				    ...
		  				    // Copy file at destination
		  				    FileHandler.copy(source3, new File("DD:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Percent\\Screenshots" 
		  				                                                   + System.currentTimeMillis() + ".png"));
		  				    System.out.println("The Screenshot of Shopping-Cart Page is taken");
		  				    Thread.sleep(2000);
			    ...
			    // Copy file at destination
			    FileHandler.copy(source4, new File("D:\\All Selenium Webdriver Screenshots\\II_LoggedIn_Customer\\Product_Percent\\Screenshots"+System.currentTimeMillis()+".png"));
