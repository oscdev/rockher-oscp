...
public class LoggedIn_Variant_Percent_I 
{
	@Test
	public void f() throws Exception 
	{
		...
		// "Product Name - Guardian Angel Earrings" 
		...
		// Go to product page
		driver.findElement(By.id("CardLink--8786366365980")).click();
		...
		String ExpectedSubTotal="Rs. 411.24";
		Thread.sleep(2000);
	    ...
	    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			String ExpectedSubTotal1="Rs. 670.50";
			Thread.sleep(2000);
		    ...
		    Thread.sleep(2000);
	              ...
	              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
	              {
	      			...
	      			String ExpectedSubTotal2="Rs. 1266.50";
	      			Thread.sleep(2000);
		...
		String ExpectedTotal1="₹1,266.50";
	    Thread.sleep(2000);
		...
		String ExpectedTotal3="₹1,380.49";
	    Thread.sleep(2000);
