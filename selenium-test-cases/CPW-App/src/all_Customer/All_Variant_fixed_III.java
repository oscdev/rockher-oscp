...
public class All_Variant_fixed_III {
	...
	public void f() throws InterruptedException, IOException {
		...
		String ExpectedSubTotal="Rs. 1821.99";
		Thread.sleep(2000);
		...
		String ExpectedTotal1="₹1,821.99";
	    Thread.sleep(2000);
		...
		String ExpectedTotal3="₹1,985.96";
	    Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Variant-fixed\\Screenshots" + System.currentTimeMillis() + ".png"));
