...
public class All_Variant_Percent_II 
{
	...
	public void f() throws Exception 
	{
		...
		// Product Name-1.Zulu 
			    ...
			    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Variant-Percent\\Screenshots" 
			    ...
			    // Copy file at destination
			    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Variant-Percent\\Screenshots" 
			                                                   + System.currentTimeMillis() + ".png"));
				...
				if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
						...
						
					{
						...
						Thread.sleep(2000);	
						String ExpectedSubTotal_1="Rs. 1695.75";
						Thread.sleep(2000);
					    ...
					    // Copy file at destination
					    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Variant-Percent\\Screenshots" 
					                                                   + System.currentTimeMillis() + ".png"));
					    System.out.println("The Screenshot of Shopping-Cart Page is taken");
					    Thread.sleep(2000);
					    ...
					    if(ActualSubTotal_1.equalsIgnoreCase(ExpectedSubTotal_1))
					    {
							...
							for(i=1;i<=5;i++) 
							{
								...
								String ExpectedSubTotal_2="Rs. 3192.00";
								Thread.sleep(2000);
							    ...
							    // Copy file at destination
							    FileHandler.copy(source3, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Variant-Percent\\Screenshots" 
							                                                   + System.currentTimeMillis() + ".png"));
							    System.out.println("The Screenshot of Shopping-Cart Page is taken");
							    Thread.sleep(2000);
				...
				Thread.sleep(2000);
				String ExpectedTotal_3="₹3,192.00";
			    Thread.sleep(2000);
			    ...
			    // Copy file at destination
			    FileHandler.copy(source4, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Variant-Percent\\Screenshots" + System.currentTimeMillis() + ".png"));
