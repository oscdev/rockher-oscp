...
public class All_VarAndProduct_fixed {
	...
	public void f() throws InterruptedException, IOException {
		...
		//Click on Search icon
				...
				driver.findElement(By.id("Search-In-Modal")).sendKeys("Floral White Top");
				driver.findElement(By.xpath("//button[@aria-label='Search']//*[name()='svg']")).click();
				
				//Opening product page
				driver.findElement(By.id("CardLink--8265127821604")).click();
