...
public class All_Product_Fixed_II {
	  	    ...
	  	    System.out.println("the Screenshot of cart page is taken");
	  		   ...
	  		   if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
	  			 ...
	  			 //Add quantity - 10
	  			    ...
	  			    // Copy file at destination
	  			    FileHandler.copy(source3, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Product_Fixed\\\\Product_Fixed\\\\screenshots"+System.currentTimeMillis()+".png"));
