...
public class All_Variant_Percent_III 
{
	@Test
	public void f() throws Exception 
	{
	    ...
	    // Copy file at destination
	    FileHandler.copy(source5, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Variant-Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    System.out.println("The Screenshot of Product Page is taken");
	    ...
	    // Copy file at destination
	    FileHandler.copy(source4, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Variant-Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    System.out.println("The Screenshot of Product Page is taken");
		...
		String ExpectedSubTotal="Rs. 4902.20";
		Thread.sleep(2000);
		...
		String ExpectedTotal1="Rs. 4902.20";
	    Thread.sleep(2000);
		...
		String ExpectedTotal3="₹5,343.40";
	    Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\All Customer\\Variant-Percent\\Screenshots" + System.currentTimeMillis() + ".png"));
