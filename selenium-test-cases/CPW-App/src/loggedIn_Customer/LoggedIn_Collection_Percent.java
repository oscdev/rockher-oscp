...
public class LoggedIn_Collection_Percent 
{
	...
	public void f() throws InterruptedException, IOException {
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Collection-Percent\\Screenshots" 
		...
		String ExpectedSubTotal="Rs. 303.60";
		Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Collection-Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    ...
	    // Copy file at destination
	    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Collection-Percent\\Screenshots" + System.currentTimeMillis() + ".png"));
