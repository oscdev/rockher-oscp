...
public class LoggedIn_Variant_Percent_II_C1 
{
	@Test
	public void f() throws Exception 
	{
		...
		if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
				...
				
			{
				...
				Thread.sleep(2000);	
				String ExpectedSubTotal_1="Rs. 1596.00";
				Thread.sleep(2000);
			    ...
			    // Copy file at destination
			    FileHandler.copy(source2, new File("D:\\\\All Selenium Webdriver Screenshots\\\\OSCP CPW Live app\\\\LoggedIn Customer\\\\Variant-Percent\\Screenshots" 
			                                                   + System.currentTimeMillis() + ".png"));
			    System.out.println("The Screenshot of Shopping-Cart Page is taken");
			    Thread.sleep(2000);
			    ...
			    if(ActualSubTotal_1.equalsIgnoreCase(ExpectedSubTotal_1))
			    {
					...
					for(i=1;i<=5;i++) 
					{
						...
						String ExpectedSubTotal_2="Rs. 2992.50";
						Thread.sleep(2000);
					    ...
					    // Copy file at destination
					    FileHandler.copy(source3, new File("D:\\\\All Selenium Webdriver Screenshots\\\\OSCP CPW Live app\\\\LoggedIn Customer\\\\Variant-Percent\\Screenshots" 
					                                                   + System.currentTimeMillis() + ".png"));
					    System.out.println("The Screenshot of Shopping-Cart Page is taken");
					    Thread.sleep(2000);
		...
		Thread.sleep(2000);
		String ExpectedTotal_3="₹2,992.50";
	    Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source4, new File("D:\\\\All Selenium Webdriver Screenshots\\\\OSCP CPW Live app\\\\LoggedIn Customer\\\\Variant-Percent\\Screenshots" + System.currentTimeMillis() + ".png"));
