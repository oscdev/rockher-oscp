...
public class LoggedIn_VarAndProduct_fixed {
	...
	public void f() throws InterruptedException, IOException {
		...
		//Click on Search icon
				...
				driver.findElement(By.id("Search-In-Modal")).sendKeys("#66 Nuroade Vapor Kit 1 Kit");
				driver.findElement(By.xpath("//button[@aria-label='Search']//*[name()='svg']")).click();
				
				//Opening product page
				driver.findElement(By.id("CardLink--8293272846628")).click();
		  ...
		  FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Variant_Vs_Product\\Screenshots" + System.currentTimeMillis() + ".png"));
		  System.out.println("the Screenshot of product page is taken");
			    ...
			    // Copy file at destination
			    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Variant_Vs_Product\\Screenshots" + System.currentTimeMillis() + ".png"));
			    System.out.println("the Screenshot of cart page is taken");
			      ...
			      // Copy file at destination
			      FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Variant_Vs_Product\\Screenshots" + System.currentTimeMillis() + ".png"));
