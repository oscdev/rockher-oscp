...
public class LoggedIn_Variant_Percent_I_C2 
{
	...
	public void f() throws InterruptedException, IOException {
       ...
       // Screenshot of product page //
		...
		String ExpectedSubTotal="Rs. 415.71";
		Thread.sleep(2000);
		...
		if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
				...
				
			{
				...
				Thread.sleep(2000);	
				String ExpectedSubTotal_1="Rs. 670.50";
				Thread.sleep(2000);
			    ...
			    if(ActualSubTotal_1.equalsIgnoreCase(ExpectedSubTotal_1))
			    {
					...
					for(i=1;i<=5;i++) 
					{
						...
						String ExpectedSubTotal_2="Rs. 1266.50";
						Thread.sleep(2000);
		...
		Thread.sleep(2000);
		String ExpectedTotal_3="₹1,266.50";
	    Thread.sleep(2000);
