...
public class LoggedIn_Variant_fixed_II_C1 
{
	...
	public void f() throws InterruptedException, IOException {
		...
		// Click on search bar and put the data
			   ...
			   Thread.sleep(5000);
				...
				String ExpectedSubTotal="Rs. 427.00";
				Thread.sleep(2000);
		...
		// Screenshot of cart page //
			    ...
			    if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal))
			    {
					...
					String ExpectedSubTotal1="Rs. 837.00";
					Thread.sleep(2000);
				    ...
				    Thread.sleep(2000);
			              ...
			              if(ActualsubTotal1.equalsIgnoreCase(ExpectedSubTotal1))
			              {
			      			...
			      			String ExpectedSubTotal2="Rs. 1497.00";
			      			Thread.sleep(2000);
				...
				String ExpectedTotal3="₹1,497.00";
			    Thread.sleep(2000);
				...
				String ExpectedTotal5="₹1,631.73";
			    Thread.sleep(2000);
