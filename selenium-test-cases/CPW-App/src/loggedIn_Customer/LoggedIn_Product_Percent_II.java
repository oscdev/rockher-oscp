...
public class LoggedIn_Product_Percent_II 
{
	...
	public void f() throws InterruptedException, IOException {
		...
		driver.findElement(By.id("Search-In-Modal")).sendKeys("chokar with triangle");
		driver.findElement(By.xpath("//button[@class='search__button field__button']")).click();
		
		// Go to product page
		driver.findElement(By.id("CardLink--8792165843236")).click();
		...
		String ExpectedSubTotal="Rs. 624.75";
		Thread.sleep(2000);
		...
		String ExpectedTotal1="Rs. 624.75";
	    Thread.sleep(2000);
