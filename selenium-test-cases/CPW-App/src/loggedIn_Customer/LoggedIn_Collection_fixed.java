...
public class LoggedIn_Collection_fixed 
{
	@Test
	public void f() throws InterruptedException, IOException {
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Collection-fixed\\Screenshots" 
		...
		String ExpectedSubTotal="Rs. 135.00";
		Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Collection-fixed\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
		...
		String ExpectedTotal1="Rs. 135.00";
	    Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Collection-fixed\\Screenshots" + System.currentTimeMillis() + ".png"));
