...
public class LoggedIn_Product_Fixed_I 
{
	...
	public void f() throws InterruptedException, IOException {
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Product_Fixed\\Screenshots" 
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Product_Fixed\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
		...
		Thread.sleep(2000);
		String ExpectedTotal1="₹525.00";
	    Thread.sleep(2000);
	    System.out.println("Without including tax Subtotal price on Checkout is ₹525.00");
		...
		String ExpectedTotal3="₹572.25";
	    Thread.sleep(2000);
	    System.out.println("With including Tax Total price on Checkout is ₹572.25");
	    ...
	    // Copy file at destination
	    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Product_Fixed\\Screenshots" + System.currentTimeMillis() + ".png"));
