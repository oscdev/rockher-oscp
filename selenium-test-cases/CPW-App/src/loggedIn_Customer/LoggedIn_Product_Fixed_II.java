...
public class LoggedIn_Product_Fixed_II 
{
	...
	public void f() throws InterruptedException, IOException {
		...
		// Product Name - Choker with Gold Pendant	[Variants - Gold / Silver]
		...
		String ExpectedSubTotal="Rs. 1600.00";
		Thread.sleep(2000);
