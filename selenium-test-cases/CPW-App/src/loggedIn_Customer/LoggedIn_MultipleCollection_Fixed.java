...
public class LoggedIn_MultipleCollection_Fixed {
	...
	public void f() throws InterruptedException, IOException {
		...
		driver.findElement(By.id("Search-In-Modal")).sendKeys("The hidden snowboard");
		driver.findElement(By.xpath("//button[@aria-label='Search']//*[name()='svg']")).click();
		
		//Opening product page
		driver.findElement(By.id("CardLink--8280370774308")).click();
		Thread.sleep(3000);
  ...
  FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Collection_Vs_Collection\\Screenshots" + System.currentTimeMillis() + ".png"));
  System.out.println("the Screenshot of product page is taken");
		...
		//camparing prices on cart page
		   ...
		   Thread.sleep(2000);
		   String ExpectedSubTotal="Rs. 1800.00";
		   Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Collection_Vs_Collection\\Screenshots" + System.currentTimeMillis() + ".png"));
	    System.out.println("the Screenshot of cart page is taken");
	      ...
	      // Copy file at destination
	      FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Collection_Vs_Collection\\Screenshots" + System.currentTimeMillis() + ".png"));
