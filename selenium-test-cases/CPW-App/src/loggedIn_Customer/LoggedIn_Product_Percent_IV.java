...
public class LoggedIn_Product_Percent_IV 
{
	...
	{		
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Product_Percent\\Screenshots" 
	    ...
	    // Copy file at destination
	    FileHandler.copy(source5, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Product_Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    System.out.println("The Screenshot of Product Page is taken");
		Thread.sleep(3000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source6, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Product_Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    System.out.println("The Screenshot of Product Page is taken");
		Thread.sleep(3000);
		...
		String ExpectedSubTotal="Rs. 770.96";
		Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Product_Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    ...
	    // Copy file at destination
	    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\LoggedIn Customer\\Product_Percent\\Screenshots" + System.currentTimeMillis() + ".png"));
