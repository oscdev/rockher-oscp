...
public class IV_1_F_Variant_20_Collection_100 {
	...
	public static void main(String[] args) throws InterruptedException, IOException
	{
	    ...
	    System.out.println("the Screenshot of cart page is taken");
		 ...
		 //camparing prices on checkout page
		   Thread.sleep(3000);
		   WebElement total = driver.findElement(By.xpath("//strong[@class='_19gi7yt0 _19gi7ytl _1fragemfm _19gi7yt1 notranslate']"));
