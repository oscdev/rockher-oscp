...
public class II_6_F_Variant_100_Product_50 {
	...
	public static void main(String[] args) throws InterruptedException, IOException
	{
		...
		//Click on Search icon
				...
				driver.findElement(By.id("Search-In-Modal")).sendKeys("#89 Serenade 60 vegcaps");
				driver.findElement(By.xpath("//button[@aria-label='Search']//*[name()='svg']")).click();
				
				//Opening product page
				driver.findElement(By.id("CardLink--8293273010468")).click();
