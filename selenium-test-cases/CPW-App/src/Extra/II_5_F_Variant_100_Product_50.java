...
public class II_5_F_Variant_100_Product_50 {
	...
	public static void main(String[] args) throws InterruptedException, IOException
	{
		...
		//Click on Search icon
				...
				driver.findElement(By.id("Search-In-Modal")).sendKeys("100% Wild Oil of Oregano 60 gels");
				driver.findElement(By.xpath("//button[@aria-label='Search']//*[name()='svg']")).click();
				
				//Opening product page
				driver.findElement(By.id("CardLink--8293272224036")).click();
