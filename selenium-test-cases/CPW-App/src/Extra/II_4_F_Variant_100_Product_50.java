...
public class II_4_F_Variant_100_Product_50 {
	...
	public static void main(String[] args) throws InterruptedException, IOException
	{
		...
		//Click on Search icon
				...
				driver.findElement(By.id("Search-In-Modal")).sendKeys("100% Wild Oil of Oregano 13.5 ml");
				driver.findElement(By.xpath("//button[@aria-label='Search']//*[name()='svg']")).click();
				
				//Opening product page
				driver.findElement(By.id("CardLink--8293272191268")).click();
			    ...
			    FileHandler.copy(source, new File("D:\\All projects screenshots\\Shopify\\CPW V2\\Variant plus product fixed price discount\\Screenshots" + System.currentTimeMillis() + ".png"));
			    System.out.println("the Screenshot of cart page is taken");
			      ...
			      // Copy file at destination
			      FileHandler.copy(source1, new File("D:\\All projects screenshots\\Shopify\\CPW V2\\Variant plus product fixed price discount\\Screenshots" + System.currentTimeMillis() + ".png"));
