...
public class I_2_P_Variant_10_Product_5 {
	...
	public static void main(String[] args) throws InterruptedException, IOException
	{
		...
		driver.findElement(By.id("Search-In-Modal")).sendKeys("Blue Silk Tuxedo");
		driver.findElement(By.xpath("//button[@aria-label='Search']//*[name()='svg']")).click();
		
		//Opening product page
		driver.findElement(By.id("CardLink--8265128345892")).click();
		...
		//camparing prices on cart page
		   ...
		   Thread.sleep(2000);
		   String ExpectedSubTotal="Rs. 189.00";
		   Thread.sleep(2000);
