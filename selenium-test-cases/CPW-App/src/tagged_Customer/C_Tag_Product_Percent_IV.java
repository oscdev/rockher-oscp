...
public class C_Tag_Product_Percent_IV 
{
	    @Test
	    ...
	    // Copy file at destination
	    FileHandler.copy(source5, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Product-Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    System.out.println("The Screenshot of Product Page is taken");
		Thread.sleep(3000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source6, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Product-Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    System.out.println("The Screenshot of Product Page is taken");
		Thread.sleep(3000);
		...
		String ExpectedSubTotal="Rs. 754.20";
		Thread.sleep(2000);
