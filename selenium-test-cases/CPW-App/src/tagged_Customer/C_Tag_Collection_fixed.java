...
public class C_Tag_Collection_fixed 
{
	@Test
	public void f() throws InterruptedException, IOException {
		...
		// Go to product page
		driver.findElement(By.id("CardLink--8293272781092")).click();
		Thread.sleep(3000);
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Collection-fixed\\Screenshots" 
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Collection-fixed\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
		...
		String ExpectedTotal1="Rs. 130.00";
	    Thread.sleep(2000);
	    System.out.println("Without including tax Subtotal price on Checkout is Rs. 130.00");
		...
		String ExpectedTotal3="₹141.70";
	    Thread.sleep(2000);
	    System.out.println("With including Tax Total price on Checkout is ₹141.70");
	    ...
	    // Copy file at destination
	    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Collection-fixed\\Screenshots" + System.currentTimeMillis() + ".png"));
