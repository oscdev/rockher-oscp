...
public class C_Tag_Variant_fixed_I_C1 
{
	@Test
	public void f() throws Exception 
	{
	    ...
	    if(ActualSubTotal.equalsIgnoreCase(ExpectedSubTotal))
	    {
			...
			for(i=1;i<=3;i++) 
			{
				...
				String ExpectedSubTotal_1="Rs. 120.00";
				Thread.sleep(2000);
			    ...
			    // Copy file at destination
			    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Variant-fixed\\Screenshots" 
			                                                   + System.currentTimeMillis() + ".png"));
			    System.out.println("The Screenshot of Shopping-Cart Page is taken");
			    Thread.sleep(2000);
			    ...
			    if(ActualSubTotal_1.equalsIgnoreCase(ExpectedSubTotal_1))
			    {
					...
					for(i=1;i<=6;i++) 
					{
						...
						String ExpectedSubTotal_2="Rs. 200.00";
						Thread.sleep(2000);
					    ...
					    // Copy file at destination
					    FileHandler.copy(source3, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Variant-fixed\\Screenshots" 
					                                                   + System.currentTimeMillis() + ".png"));
					    System.out.println("The Screenshot of Shopping-Cart Page is taken");
					    Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source4, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Variant-fixed\\Screenshots" + System.currentTimeMillis() + ".png"));
