...
public class C_Tag_ProductAndCollection_Fixed {
	...
	public void f() throws InterruptedException, IOException {
		...
		driver.findElement(By.id("Search-In-Modal")).sendKeys("1+ Vitamin Mineral Vegetarian 120 tabs");
		driver.findElement(By.xpath("//button[@aria-label='Search']//*[name()='svg']")).click();
		
		//Opening product page
		driver.findElement(By.id("CardLink--8293272486180")).click();
  ...
  FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Product_Vs_Collection\\Screenshots" + System.currentTimeMillis() + ".png"));
  System.out.println("the Screenshot of product page is taken");
		...
		//camparing prices on cart page
		   ...
		   Thread.sleep(2000);
		   String ExpectedSubTotal="Rs. 200.00";
		   Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source1, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Product_Vs_Collection\\Screenshots" + System.currentTimeMillis() + ".png"));
	    System.out.println("the Screenshot of cart page is taken");
	      ...
	      // Copy file at destination
	      FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Product_Vs_Collection\\Screenshots" + System.currentTimeMillis() + ".png"));
