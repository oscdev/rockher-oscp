...
public class C_Tag_ProductAndCollection_Percent {
	@Test
	public void f() throws InterruptedException, IOException {
		...
		driver.findElement(By.id("Search-In-Modal")).sendKeys("35 Jointade Vapor Kit 1 Kit");
		driver.findElement(By.xpath("//button[@aria-label='Search']//*[name()='svg']")).click();
		
		//Opening product page
		driver.findElement(By.id("CardLink--8293272584484")).click();
  ...
  System.out.println("the Screenshot of product page is taken");
		...
		//camparing prices on cart page
		   ...
		   Thread.sleep(2000);
		   String ExpectedSubTotal="Rs. 172.90";
		   Thread.sleep(2000);
