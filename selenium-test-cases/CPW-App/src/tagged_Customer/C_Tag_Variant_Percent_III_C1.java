...
public class C_Tag_Variant_Percent_III_C1 
{
	@Test
	public void f() throws Exception 
	{
		...
		// Product Name-1.Guardian Angel Earrings 		// Click on search icon
	    ...
	    // Copy file at destination
	    FileHandler.copy(source5, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Variant-Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    System.out.println("The Screenshot of Product Page is taken");
	    ...
	    // Copy file at destination
	    FileHandler.copy(source4, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Variant-Percent\\Screenshots" 
	                                                   + System.currentTimeMillis() + ".png"));
	    System.out.println("The Screenshot of Product Page is taken");
		...
		String ExpectedSubTotal="Rs. 4384.00";
		Thread.sleep(2000);
		...
		String ExpectedTotal1="Rs. 4384.00";
	    Thread.sleep(2000);
		...
		String ExpectedTotal3="₹4,778.56";
	    Thread.sleep(2000);
	    ...
	    // Copy file at destination
	    FileHandler.copy(source2, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Variant-Percent\\Screenshots" + System.currentTimeMillis() + ".png"));
