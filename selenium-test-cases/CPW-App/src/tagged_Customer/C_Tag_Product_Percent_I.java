...
public class C_Tag_Product_Percent_I 
{
	...
	public void f() throws InterruptedException, IOException {
		...
		String ExpectedSubTotal="Rs. 142.20";
		Thread.sleep(2000);
		...
		String ExpectedTotal1="Rs. 142.20";
	    Thread.sleep(2000);
	    System.out.println("Without including tax Subtotal price on Checkout is Rs. 142.20");
		...
		String ExpectedTotal3="₹155.00";
	    Thread.sleep(2000);
	    System.out.println("With including Tax Total price on Checkout is ₹155.00");
