...
public class C_Tag_Product_Fixed_II 
{
	...
	public void f() throws InterruptedException, IOException {
	    ...
	    FileHandler.copy(source, new File("D:\\All Selenium Webdriver Screenshots\\OSCP CPW Live app\\Tagged Customer\\Product-Fixed\\Screenshots" 
		...
		String ExpectedSubTotal="Rs. 1500.00";
		Thread.sleep(2000);
		...
		String ExpectedTotal1="₹1500.00";
	    Thread.sleep(2000);
	    System.out.println("Without including tax Subtotal price on Checkout is ₹1500.00");
		...
		String ExpectedTotal3="₹1635.00";
	    Thread.sleep(2000);
	    System.out.println("With including Tax Total price on Checkout is ₹1635.00");
