...
public class C_Tag_Variant_Percent_I_C1 
{
		...
		if(ActualsubTotal.equalsIgnoreCase(ExpectedSubTotal)) 
			...
			// Add quantity
							...
							
						{
							...
							Thread.sleep(2000);	
							String ExpectedSubTotal_1="Rs. 633.25";
							Thread.sleep(2000);
						    ...
						    if(ActualSubTotal_1.equalsIgnoreCase(ExpectedSubTotal_1))
						    {
								...
								for(i=1;i<=5;i++) 
								{
									...
									String ExpectedSubTotal_2="Rs. 1192.00";
									Thread.sleep(2000);
					...
					Thread.sleep(2000);
					String ExpectedTotal_3="₹1,192.00";
				    Thread.sleep(2000);
